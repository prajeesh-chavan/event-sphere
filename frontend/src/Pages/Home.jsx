...
const HeroSection = () => {
  return (
    <section className="h-screen flex items-center justify-center bg-[url('./event-bg.jpg')] bg-cover bg-slate-50/10">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 flex flex-col items-center">
        ...
        <p className="text-lg mb-8 font-normal text-slate-100 lg:text-xl sm:px-16 xl:px-48">
          EventSphere simplifies event booking, offering real-time availability,
          ticket management, and secure payments, all in one place.
        </p>
        ...
        <Button variant="super">Browse Events</Button>
