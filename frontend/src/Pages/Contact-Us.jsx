...
const ContactUs = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-l from-sky-100/80 via-white to-sky-100/80 pt-12">
      <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md mt-32">
